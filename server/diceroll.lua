...
QBCore.Commands.Add("roll", "Choose a random number", {{name="ammount", help="Amount of dices"}, {name="sides", help="Amount of sides of the dice"}}, true, function(source, args) -- Eigen add command functie mot je vervangen naar esx versie
