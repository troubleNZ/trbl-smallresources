	...
	while true do
		...
		if IsPedInAnyVehicle(ped) then
			if driver == ped and IsVehicleOnAllWheels(vehicle) then
				...
				if IsControlJustReleased(0, 171) and ((GetVehicleClass(vehicle) == 0) or (GetVehicleClass(vehicle) == 1) or (GetVehicleClass(vehicle) == 2) or (GetVehicleClass(vehicle) == 3) or (GetVehicleClass(vehicle) == 4) or (GetVehicleClass(vehicle) == 5) or (GetVehicleClass(vehicle) == 6) or (GetVehicleClass(vehicle) == 7) or (GetVehicleClass(vehicle) == 9)) then
