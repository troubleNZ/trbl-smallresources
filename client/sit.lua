...
Citizen.CreateThread(function()
	...
	for k,v in pairs(SitConfig.Interactables) do
...
function GetNearChair()
	...
	for i=1, #SitConfig.Interactables do
		object = GetClosestObjectOfType(coords, 3.0, GetHashKey(SitConfig.Interactables[i]), false, false, false)
