...
RegisterCommand("icsstart", function() -- Command for trigger
...
AddEventHandler('introCinematic:start', function()
    ...
    --Wait(15520) --- custscene time
        ...
        SetEntityCoords(PlayerPedId(),-1036.37, -2731.94, 13.76)
        --if type(Config.Airport[loc][2].coords) == "vector4" then
        SetEntityHeading(PlayerPedId(), 330.3)
        --end
        Citizen.Wait(2000)
        StopCutsceneImmediately()
        DoScreenFadeIn(1000)
        --SetEntityCoords(PlayerPedId(), Config.Airport[loc][2].coords.x, Config.Airport[loc][2].coords.y, Config.Airport[loc][2].coords.z)
        --if type(Config.Airport[loc][2].coords) == "vector4" then
        --    SetEntityHeading(PlayerPedId(), Config.Airport[loc][2].coords.w)
        --end
        Wait(1000)
end) 
